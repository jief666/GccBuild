...
enum opt_code
{
  ...
  OPT_fgnu_unique = 671,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 672,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 673,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 674,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 675,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 676,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 677,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 678,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 679,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 680,                       /* -fgraphite */
  OPT_fgraphite_identity = 681,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 682,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 683, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 684, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 685,           /* -fhash-synchronization */
  /* OPT_fhelp = 686, */                     /* -fhelp */
  /* OPT_fhelp_ = 687, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 688,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 689, */                /* -fhonor-std */
  OPT_fhosted = 690,                         /* -fhosted */
  /* OPT_fhuge_objects = 691, */             /* -fhuge-objects */
  OPT_fident = 692,                          /* -fident */
  OPT_fif_conversion = 693,                  /* -fif-conversion */
  OPT_fif_conversion2 = 694,                 /* -fif-conversion2 */
  OPT_filelist = 695,                        /* -filelist */
  OPT_fimplement_inlines = 696,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 697,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 698,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 699,             /* -fimplicit-templates */
  OPT_findirect_classes = 700,               /* -findirect-classes */
  OPT_findirect_dispatch = 701,              /* -findirect-dispatch */
  OPT_findirect_inlining = 702,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 703,         /* -findirect-virtual-calls */
  ...
  OPT_finline_small_functions = 716,         /* -finline-small-functions */
  OPT_finput_charset_ = 717,                 /* -finput-charset= */
  OPT_finstrument_functions = 718,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 719,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 720,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 721,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 722,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 723,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 724,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 725,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 726, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 727,                    /* -fipa-profile */
  OPT_fipa_pta = 728,                        /* -fipa-pta */
  OPT_fipa_pure_const = 729,                 /* -fipa-pure-const */
  OPT_fipa_reference = 730,                  /* -fipa-reference */
  OPT_fipa_sra = 731,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 732, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 733,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 734,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 735,              /* -fira-loop-pressure */
  OPT_fira_region_ = 736,                    /* -fira-region= */
  OPT_fira_share_save_slots = 737,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 738,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 739,                   /* -fira-verbose= */
  OPT_fivopts = 740,                         /* -fivopts */
  OPT_fjni = 741,                            /* -fjni */
  OPT_fjump_tables = 742,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 743,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 744,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 745,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 746, */                /* -flabels-ok */
  /* OPT_flat_namespace = 747, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 748,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 749,             /* -fleading-underscore */
  OPT_floop_block = 750,                     /* -floop-block */
  /* OPT_floop_flatten = 751, */             /* -floop-flatten */
  OPT_floop_interchange = 752,               /* -floop-interchange */
  OPT_floop_nest_optimize = 753,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 754, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 755,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 756,                /* -floop-strip-mine */
  OPT_flto = 757,                            /* -flto */
  OPT_flto_compression_level_ = 758,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 759,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 760,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 761,              /* -flto-partition=max */
  OPT_flto_partition_none = 762,             /* -flto-partition=none */
  OPT_flto_report = 763,                     /* -flto-report */
  OPT_flto_ = 764,                           /* -flto= */
  OPT_fltrans = 765,                         /* -fltrans */
  OPT_fltrans_output_list_ = 766,            /* -fltrans-output-list= */
  OPT_fmain_ = 767,                          /* -fmain= */
  OPT_fmath_errno = 768,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 769,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 770,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 771,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 772,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 773,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 774,                     /* -fmem-report */
  OPT_fmem_report_wpa = 775,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 776,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 777,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 778,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 779,                /* -fmessage-length= */
  OPT_fmodule_private = 780,                 /* -fmodule-private */
  OPT_fmodulo_sched = 781,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 782,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 783,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 784,                  /* -fms-extensions */
  OPT_fmudflap = 785,                        /* -fmudflap */
  OPT_fmudflapir = 786,                      /* -fmudflapir */
  OPT_fmudflapth = 787,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 788, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 789, */                  /* -fnew-abi */
  OPT_fnext_runtime = 790,                   /* -fnext-runtime */
  OPT_fnil_receivers = 791,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 792,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 793,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 794, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 795,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 796,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 797,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 798,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 799,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 800,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 801,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 802,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 803,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 804,             /* -fomit-frame-pointer */
  OPT_fopenmp = 805,                         /* -fopenmp */
  OPT_foperator_names = 806,                 /* -foperator-names */
  OPT_fopt_info = 807,                       /* -fopt-info */
  OPT_fopt_info_ = 808,                      /* -fopt-info- */
  OPT_foptimize_register_move = 809,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 810,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 811,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 812,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 813, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 814, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 815, */      /* -force_flat_namespace */
  OPT_foutput_class_dir_ = 816,              /* -foutput-class-dir= */
  OPT_fpack_derived = 817,                   /* -fpack-derived */
  OPT_fpack_struct = 818,                    /* -fpack-struct */
  OPT_fpack_struct_ = 819,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 820,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 821,              /* -fpcc-struct-return */
  OPT_fpch_deps = 822,                       /* -fpch-deps */
  OPT_fpch_preprocess = 823,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 824,                     /* -fpeel-loops */
  OPT_fpeephole = 825,                       /* -fpeephole */
  OPT_fpeephole2 = 826,                      /* -fpeephole2 */
  OPT_fpermissive = 827,                     /* -fpermissive */
  OPT_fpic = 828,                            /* -fpic */
  OPT_fpie = 829,                            /* -fpie */
  OPT_fplan9_extensions = 830,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 831,                    /* -fplugin-arg- */
  OPT_fplugin_ = 832,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 833,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 834,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 835,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 836,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 837,                   /* -fpreprocessed */
  OPT_fpretty_templates = 838,               /* -fpretty-templates */
  OPT_fprofile = 839,                        /* -fprofile */
  OPT_fprofile_arcs = 840,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 841,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 842,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 843,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 844,              /* -fprofile-generate= */
  OPT_fprofile_report = 845,                 /* -fprofile-report */
  ...
  OPT_framework = 850,                       /* -framework */
  OPT_frandom_seed = 851,                    /* -frandom-seed */
  OPT_frandom_seed_ = 852,                   /* -frandom-seed= */
  OPT_frange_check = 853,                    /* -frange-check */
  OPT_freal_4_real_10 = 854,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 855,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 856,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 857,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 858,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 859,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 860,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 861,                /* -freciprocal-math */
  ...
  OPT_frepack_arrays = 874,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 875,           /* -freplace-objc-classes */
  OPT_frepo = 876,                           /* -frepo */
  OPT_frequire_return_statement = 877,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 878,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 879, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 880,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 881,                    /* -fresolution= */
  OPT_frounding_math = 882,                  /* -frounding-math */
  OPT_frtti = 883,                           /* -frtti */
  OPT_fsanitize_address = 884,               /* -fsanitize=address */
  OPT_fsanitize_thread = 885,                /* -fsanitize=thread */
  OPT_fsaw_java_file = 886,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 887,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 888,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 889,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 890,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 891,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 892,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 893,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 894,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 895,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 896,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 897,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 898,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 899,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 900,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 901,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 902,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 903,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 904, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 905,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 906,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 907,              /* -fsecond-underscore */
  OPT_fsection_anchors = 908,                /* -fsection-anchors */
  /* OPT_fsee = 909, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 910,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 911,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 912, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 913,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 914,          /* -fselective-scheduling2 */
  OPT_fshort_double = 915,                   /* -fshort-double */
  OPT_fshort_enums = 916,                    /* -fshort-enums */
  OPT_fshort_wchar = 917,                    /* -fshort-wchar */
  OPT_fshow_column = 918,                    /* -fshow-column */
  OPT_fshrink_wrap = 919,                    /* -fshrink-wrap */
  OPT_fsign_zero = 920,                      /* -fsign-zero */
  OPT_fsignaling_nans = 921,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 922,               /* -fsigned-bitfields */
  OPT_fsigned_char = 923,                    /* -fsigned-char */
  OPT_fsigned_zeros = 924,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 925,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 926,               /* -fsource-filename= */
  OPT_fsource_ = 927,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 928,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 929,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 930,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 931, */                 /* -fsquangle */
  OPT_fstack_arrays = 932,                   /* -fstack-arrays */
  /* OPT_fstack_check = 933, */              /* -fstack-check */
  OPT_fstack_check_ = 934,                   /* -fstack-check= */
  OPT_fstack_limit = 935,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 936,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 937,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 938,                /* -fstack-protector */
  OPT_fstack_protector_all = 939,            /* -fstack-protector-all */
  OPT_fstack_reuse_ = 940,                   /* -fstack-reuse= */
  OPT_fstack_usage = 941,                    /* -fstack-usage */
  OPT_fstats = 942,                          /* -fstats */
  OPT_fstore_check = 943,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 944, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 945,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 946,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 947,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 948, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 949,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 950,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 951,                    /* -fsyntax-only */
  OPT_ftabstop_ = 952,                       /* -ftabstop= */
  /* OPT_ftarget_help = 953, */              /* -ftarget-help */
  OPT_ftarget_ = 954,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 955,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 956, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 957,                /* -ftemplate-depth= */
  OPT_fterminated_vtables = 958,             /* -fterminated-vtables */
  OPT_ftest_coverage = 959,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 960, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 961,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 962,             /* -fthreadsafe-statics */
  OPT_ftime_report = 963,                    /* -ftime-report */
  OPT_ftls_model_ = 964,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 965,               /* -ftoplevel-reorder */
  OPT_ftracer = 966,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 967,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 968,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 969,                  /* -ftrapping-math */
  OPT_ftrapv = 970,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 971,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 972,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 973,                       /* -ftree-ccp */
  OPT_ftree_ch = 974,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 975,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 976,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 977,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 978,                /* -ftree-copyrename */
  OPT_ftree_cselim = 979,                    /* -ftree-cselim */
  OPT_ftree_dce = 980,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 981,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 982,                       /* -ftree-dse */
  OPT_ftree_forwprop = 983,                  /* -ftree-forwprop */
  OPT_ftree_fre = 984,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 985,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 986,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 987,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 988,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 989,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 990,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 991, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 992,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 993,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 994,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 995,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 996,                   /* -ftree-phiprop */
  OPT_ftree_pre = 997,                       /* -ftree-pre */
  OPT_ftree_pta = 998,                       /* -ftree-pta */
  OPT_ftree_reassoc = 999,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 1000, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1001,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1002,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1003,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1004,                     /* -ftree-slsr */
  OPT_ftree_sra = 1005,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1006, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1007, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1008,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1009,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1010,                      /* -ftree-ter */
  OPT_ftree_vect_loop_version = 1011,        /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1012,                /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 1013,      /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1014,                      /* -ftree-vrp */
  OPT_funderscoring = 1015,                  /* -funderscoring */
  OPT_funit_at_a_time = 1016,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1017,              /* -funroll-all-loops */
  OPT_funroll_loops = 1018,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1019,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1020,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1021,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1022,                 /* -funsigned-char */
  OPT_funswitch_loops = 1023,                /* -funswitch-loops */
  OPT_funwind_tables = 1024,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1025,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1026,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1027,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1028,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1029,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1030,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1031,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1032,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1033,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1034,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1035,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1036,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1037,/* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 1038,               /* -fvect-cost-model */
  OPT_fverbose_asm = 1039,                   /* -fverbose-asm */
  /* OPT_fversion = 1040, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1041,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1042,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1043,                   /* -fvisibility= */
  OPT_fvpt = 1044,                           /* -fvpt */
  /* OPT_fvtable_gc = 1045, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1046, */           /* -fvtable-thunks */
  OPT_fweak = 1047,                          /* -fweak */
  OPT_fweb = 1048,                           /* -fweb */
  OPT_fwhole_file = 1049,                    /* -fwhole-file */
  OPT_fwhole_program = 1050,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1051,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1052,             /* -fworking-directory */
  OPT_fwpa = 1053,                           /* -fwpa */
  OPT_fwrapv = 1054,                         /* -fwrapv */
  /* OPT_fxref = 1055, */                    /* -fxref */
  /* OPT_fzee = 1056, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1057,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1058,                     /* -fzero-link */
  OPT_g = 1059,                              /* -g */
  OPT_gant = 1060,                           /* -gant */
  OPT_gcoff = 1061,                          /* -gcoff */
  OPT_gdwarf_ = 1062,                        /* -gdwarf- */
  OPT_gen_decls = 1063,                      /* -gen-decls */
  OPT_gfull = 1064,                          /* -gfull */
  OPT_ggdb = 1065,                           /* -ggdb */
  OPT_gnat = 1066,                           /* -gnat */
  OPT_gnatO = 1067,                          /* -gnatO */
  OPT_gno_pubnames = 1068,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1069,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1070,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1071,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1072,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1073,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1074,                   /* -gsplit-dwarf */
  OPT_gstabs = 1075,                         /* -gstabs */
  OPT_gstabs_ = 1076,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1077,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1078,                        /* -gtoggle */
  OPT_gused = 1079,                          /* -gused */
  OPT_gvms = 1080,                           /* -gvms */
  OPT_gxcoff = 1081,                         /* -gxcoff */
  OPT_gxcoff_ = 1082,                        /* -gxcoff+ */
  OPT_h = 1083,                              /* -h */
  OPT_headerpad_max_install_names = 1084,    /* -headerpad_max_install_names */
  OPT_idirafter = 1085,                      /* -idirafter */
  OPT_iframework = 1086,                     /* -iframework */
  OPT_imacros = 1087,                        /* -imacros */
  /* OPT_image_base = 1088, */               /* -image_base */
  OPT_imultiarch = 1089,                     /* -imultiarch */
  OPT_imultilib = 1090,                      /* -imultilib */
  OPT_include = 1091,                        /* -include */
  /* OPT_init = 1092, */                     /* -init */
  /* OPT_install_name = 1093, */             /* -install_name */
  OPT_iplugindir_ = 1094,                    /* -iplugindir= */
  OPT_iprefix = 1095,                        /* -iprefix */
  OPT_iquote = 1096,                         /* -iquote */
  OPT_isysroot = 1097,                       /* -isysroot */
  OPT_isystem = 1098,                        /* -isystem */
  OPT_iwithprefix = 1099,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1100,              /* -iwithprefixbefore */
  OPT_k8 = 1101,                             /* -k8 */
  OPT_keep_private_externs = 1102,           /* -keep_private_externs */
  OPT_l = 1103,                              /* -l */
  OPT_lang_asm = 1104,                       /* -lang-asm */
  OPT_m128bit_long_double = 1105,            /* -m128bit-long-double */
  OPT_m32 = 1106,                            /* -m32 */
  OPT_m3dnow = 1107,                         /* -m3dnow */
  OPT_m3dnowa = 1108,                        /* -m3dnowa */
  OPT_m64 = 1109,                            /* -m64 */
  OPT_m80387 = 1110,                         /* -m80387 */
  OPT_m8bit_idiv = 1111,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1112,             /* -m96bit-long-double */
  OPT_mabi_ = 1113,                          /* -mabi= */
  OPT_mabm = 1114,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1115,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1116,                 /* -maddress-mode= */
  OPT_madx = 1117,                           /* -madx */
  OPT_maes = 1118,                           /* -maes */
  OPT_malign_double = 1119,                  /* -malign-double */
  OPT_malign_functions_ = 1120,              /* -malign-functions= */
  OPT_malign_jumps_ = 1121,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1122,                  /* -malign-loops= */
  OPT_malign_stringops = 1123,               /* -malign-stringops */
  OPT_march_ = 1124,                         /* -march= */
  OPT_masm_ = 1125,                          /* -masm= */
  OPT_matt_stubs = 1126,                     /* -matt-stubs */
  OPT_mavx = 1127,                           /* -mavx */
  OPT_mavx2 = 1128,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1129,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1130,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1131,                           /* -mbmi */
  OPT_mbmi2 = 1132,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1133,                  /* -mbranch-cost= */
  OPT_mcld = 1134,                           /* -mcld */
  OPT_mcmodel_ = 1135,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1136,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1137, */                    /* -mcpu= */
  OPT_mcrc32 = 1138,                         /* -mcrc32 */
  OPT_mcx16 = 1139,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1140,            /* -mdispatch-scheduler */
  OPT_mdynamic_no_pic = 1141,                /* -mdynamic-no-pic */
  OPT_mf16c = 1142,                          /* -mf16c */
  OPT_mfancy_math_387 = 1143,                /* -mfancy-math-387 */
  OPT_mfentry = 1144,                        /* -mfentry */
  OPT_mfix_and_continue = 1145,              /* -mfix-and-continue */
  OPT_mfma = 1146,                           /* -mfma */
  OPT_mfma4 = 1147,                          /* -mfma4 */
  OPT_mforce_drap = 1148,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1149,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1150,                       /* -mfpmath= */
  OPT_mfsgsbase = 1151,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1152, */              /* -mfused-madd */
  OPT_mfxsr = 1153,                          /* -mfxsr */
  OPT_mhard_float = 1154,                    /* -mhard-float */
  OPT_mhle = 1155,                           /* -mhle */
  OPT_mieee_fp = 1156,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1157,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1158,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1159,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1160, */            /* -mintel-syntax */
  OPT_mkernel = 1161,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1162,         /* -mlarge-data-threshold= */
  OPT_mlong_double_64 = 1163,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1164,                /* -mlong-double-80 */
  OPT_mlwp = 1165,                           /* -mlwp */
  OPT_mlzcnt = 1166,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1167,           /* -mmacosx-version-min= */
  OPT_mmmx = 1168,                           /* -mmmx */
  OPT_mmovbe = 1169,                         /* -mmovbe */
  OPT_mms_bitfields = 1170,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1171,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1172,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1173,                  /* -mno-push-args */
  OPT_mno_red_zone = 1174,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1175,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1176,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1177,                 /* -mone-byte-bool */
  OPT_mpc32 = 1178,                          /* -mpc32 */
  OPT_mpc64 = 1179,                          /* -mpc64 */
  OPT_mpc80 = 1180,                          /* -mpc80 */
  OPT_mpclmul = 1181,                        /* -mpclmul */
  OPT_mpopcnt = 1182,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1183,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1184,     /* -mpreferred-stack-boundary= */
  OPT_mprfchw = 1185,                        /* -mprfchw */
  OPT_mpush_args = 1186,                     /* -mpush-args */
  OPT_mrdrnd = 1187,                         /* -mrdrnd */
  OPT_mrdseed = 1188,                        /* -mrdseed */
  OPT_mrecip = 1189,                         /* -mrecip */
  OPT_mrecip_ = 1190,                        /* -mrecip= */
  OPT_mred_zone = 1191,                      /* -mred-zone */
  OPT_mregparm_ = 1192,                      /* -mregparm= */
  OPT_mrtd = 1193,                           /* -mrtd */
  OPT_mrtm = 1194,                           /* -mrtm */
  OPT_msahf = 1195,                          /* -msahf */
  OPT_msoft_float = 1196,                    /* -msoft-float */
  OPT_msse = 1197,                           /* -msse */
  OPT_msse2 = 1198,                          /* -msse2 */
  OPT_msse2avx = 1199,                       /* -msse2avx */
  OPT_msse3 = 1200,                          /* -msse3 */
  OPT_msse4 = 1201,                          /* -msse4 */
  OPT_msse4_1 = 1202,                        /* -msse4.1 */
  OPT_msse4_2 = 1203,                        /* -msse4.2 */
  OPT_msse4a = 1204,                         /* -msse4a */
  /* OPT_msse5 = 1205, */                    /* -msse5 */
  OPT_msseregparm = 1206,                    /* -msseregparm */
  OPT_mssse3 = 1207,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1208,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1209,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1210,            /* -mstringop-strategy= */
  OPT_mtbm = 1211,                           /* -mtbm */
  OPT_mtls_dialect_ = 1212,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1213,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1214,                         /* -mtune= */
  /* OPT_multi_module = 1215, */             /* -multi_module */
  /* OPT_multiply_defined = 1216, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1217, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1218,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1219,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1220,                    /* -mvzeroupper */
  OPT_mx32 = 1221,                           /* -mx32 */
  OPT_mxop = 1222,                           /* -mxop */
  OPT_mxsave = 1223,                         /* -mxsave */
  OPT_mxsaveopt = 1224,                      /* -mxsaveopt */
  OPT_n = 1225,                              /* -n */
  OPT_no_canonical_prefixes = 1226,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1227,              /* -no-integrated-cpp */
  /* OPT_no_dead_strip_inits_and_terms = 1228, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1229,                          /* -nocpp */
  OPT_nodefaultlibs = 1230,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1231,                /* -nofixprebinding */
  OPT_nomultidefs = 1232,                    /* -nomultidefs */
  OPT_noprebind = 1233,                      /* -noprebind */
  OPT_noseglinkedit = 1234,                  /* -noseglinkedit */
  OPT_nostartfiles = 1235,                   /* -nostartfiles */
  OPT_nostdinc = 1236,                       /* -nostdinc */
  OPT_nostdinc__ = 1237,                     /* -nostdinc++ */
  OPT_nostdlib = 1238,                       /* -nostdlib */
  OPT_o = 1239,                              /* -o */
  OPT_object = 1240,                         /* -object */
  OPT_p = 1241,                              /* -p */
  OPT_pagezero_size = 1242,                  /* -pagezero_size */
  ...
  OPT_pie = 1247,                            /* -pie */
  OPT_pipe = 1248,                           /* -pipe */
  OPT_prebind = 1249,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1250,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1251,                        /* -preload */
  ...
  OPT_private_bundle = 1263,                 /* -private_bundle */
  OPT_pthread = 1264,                        /* -pthread */
  OPT_quiet = 1265,                          /* -quiet */
  OPT_r = 1266,                              /* -r */
  OPT_read_only_relocs = 1267,               /* -read_only_relocs */
  OPT_remap = 1268,                          /* -remap */
  OPT_s = 1269,                              /* -s */
  OPT_s_bc_abi = 1270,                       /* -s-bc-abi */
  OPT_save_temps = 1271,                     /* -save-temps */
  OPT_save_temps_ = 1272,                    /* -save-temps= */
  OPT_sectalign = 1273,                      /* -sectalign */
  OPT_sectcreate = 1274,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1275,              /* -sectobjectsymbols */
  OPT_sectorder = 1276,                      /* -sectorder */
  OPT_seg1addr = 1277,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1278, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1279, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1280, */                  /* -segaddr */
  OPT_segcreate = 1281,                      /* -segcreate */
  OPT_seglinkedit = 1282,                    /* -seglinkedit */
  OPT_segprot = 1283,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1284, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1285, */     /* -segs_read_write_addr */
  OPT_shared = 1286,                         /* -shared */
  OPT_shared_libgcc = 1287,                  /* -shared-libgcc */
  /* OPT_single_module = 1288, */            /* -single_module */
  ...
  OPT_std_gnu__98 = 1319,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1320,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1321, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1322, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1323,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1324,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1325, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1326, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1327,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1328, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1329, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1330, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1331,                     /* -std=legacy */
  OPT_sub_library = 1332,                    /* -sub_library */
  OPT_sub_umbrella = 1333,                   /* -sub_umbrella */
  ...
  OPT_twolevel_namespace = 1341,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1342,       /* -twolevel_namespace_hints */
  OPT_u = 1343,                              /* -u */
  /* OPT_umbrella = 1344, */                 /* -umbrella */
  OPT_undef = 1345,                          /* -undef */
  OPT_undefined = 1346,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1347, */  /* -unexported_symbols_list */
  OPT_v = 1348,                              /* -v */
  OPT_version = 1349,                        /* -version */
  OPT_w = 1350,                              /* -w */
  /* OPT_weak_reference_mismatches = 1351, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1352,                    /* -whatsloaded */
  OPT_whyload = 1353,                        /* -whyload */
  OPT_wrapper = 1354,                        /* -wrapper */
  OPT_x = 1355,                              /* -x */
  OPT_y = 1356,                              /* -y */
  OPT_z = 1357,                              /* -z */
  N_OPTS,
